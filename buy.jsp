...
<td>
	<form action="transaction" method="post">
		<button type="submit" name="type" style = "padding-bottom: 10px;" class = "btn btn-primary" VALUE="buymarketorder">Market Order</button>
		<input id="textfield" name="marketquant" style = "padding-top: 5px;" class = "input" type="text" placeholder="quantity"> <br>
	</form>
</td>
<td>	
	<form action="transaction" method="post">
		<button type="submit" name="type" style = "padding-bottom: 10px;" class = "btn btn-primary" VALUE="buylimitorder" >Limit Order</button>
